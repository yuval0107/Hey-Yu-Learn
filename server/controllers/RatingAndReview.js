...
exports.createRating = async (req, res) => {
    try {
        ...
        // If user not found in enrollment, try to auto-enroll (handles legacy data issues)
        if (!courseDetails) {
            const courseExists = await Course.findById(courseId);
            if (courseExists) {
                // Auto-enroll user (useful for courses where enrollment wasn't properly recorded)
